...
// @author       Miguel19877 | Patches By Maddex
      ...
      // CREATION OF AUTOSELL FUNCTION PART
        ...
        if (currentDirectory == "/cases/cases"){
          ...
          if (currentDirectory.startsWith("/cases/")){
            ...
            if (upgraderactive){
              setTimeout(async function(){
                let casebuttons = document.getElementsByClassName("m_c0783ff9 mantine-ScrollArea-viewport")[0];
                ...
                upgradertempbutton.style = "width: 150px; height: 30px; font-size: 12px; margin-left: 20px; margin-right: 10px; background-color: #da1b0f; border: none; border-radius: 5px; color: white;";
